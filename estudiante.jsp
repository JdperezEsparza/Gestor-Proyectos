            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="estudiante.jsp"><i class="bi bi-person"></i> Perfil</a></li>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="gestionProyectosEstudiante.jsp" class="list-group-item list-group-item-action">
                        ...
                        <c:choose>
                            <c:when test="${sessionScope.rol == 'Estudiante'}">
                                <div class="alert alert-warning">
                                    <h5><i class="bi bi-shield-lock"></i> Panel de estudiantes</h5>
                                    <p>Acceso a las funciones de estudiante</p>
                                    ...
                                    <div class="container mt-5">
                                        <div class="row row-cols-1 row-cols-md-2 g-4">
                                          ...
                                          <div class="col">
                                            <a href="gestionProyectosEstudiante.jsp" class="text-decoration-none">

  ...
  <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ taglib prefix="sql" uri="http://java.sun.com/jsp/jstl/sql" %>
      <%@include file="WEB-INF/jspf/conexion.jspf" %>
        ...
        <head>
          <meta charset="UTF-8">
          <title>Panel de Control coordinacion</title>
          <!-- Bootstrap CSS -->
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a class="dropdown-item text-danger" href="index.jsp"><i class="bi bi-box-arrow-right"></i>
                        Cerrar sesión</a></li>
                  </ul>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="list-group list-group-flush">
                    ...
                    <a href="#" class="list-group-item list-group-item-action">
                      <i class="bi bi-file-earmark-text"></i> Gestión de ideas
                    </a>

                    <a href="gestionProyectosCordinador.jsp" class="list-group-item list-group-item-action">
              ...
              <div class="col-md-9">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <c:choose>
                      <c:when test="${sessionScope.rol == 'Coordinacion'}">
                        <div class="alert alert-warning">
                          <h5><i class="bi bi-shield-lock"></i> Panel de Coordinacion</h5>
                          <p>Acceso a funciones del coordinador</p>
                          <div class="container mt-5">
                            <div class="row row-cols-1 row-cols-md-2 g-4">

                              <div class="col">
                                <a href="gestionIdeas.jsp" class="text-decoration-none">
                                  <div class="card  h-100 text-center special-card">
                                    <div class="card-body">
                                      <i class="bi bi-lightbulb fs-1"></i>
                                      <h5 class="card-title mt-2">Gestión de ideas</h5>
                                    </div>
                                  </div>
                                </a>
                              </div>
                              ...
                              <div class="col">
                                <a href="gestionProyectosCordinador.jsp" class="text-decoration-none">
                                  <div class="card  h-100 text-center special-card">
                                    <div class="card-body">

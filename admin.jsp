            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="admin.jsp"><i class="bi bi-person"></i> Perfil</a>
                        </li>
                        <li>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="list-group list-group-flush">
                        ...
                        <a href="gestionUsuarios.jsp" class="list-group-item list-group-item-action" >
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            <i class="bi bi-info-circle"></i> Rol actual:
                        ...
                        <c:choose>
                            <c:when test="${sessionScope.rol == 'Administrador'}">
                                <div class="alert alert-warning">
                                    <h5><i class="bi bi-shield-lock"></i> Panel de Administración</h5>
                                    ...
                                    <div class="container mt-5">
                                        <div class="row row-cols-1 row-cols-md-2 g-4">
                                            ...
                                            <div class="col">
                                                <a href="gestionUsuarios.jsp" class="text-decoration-none" >
